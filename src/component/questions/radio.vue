  ...
  .view {
    ...
    .questions-options-list {
      ...
      .questions-options {
        ...
        .icon {
          position: absolute; left: -30px; top: -1px; display: block; width: 16px; height: 16px; background: url(http://himg2.huanqiu.com/survey/assets/skin_default_icon.png) no-repeat -17px 0;
        }
